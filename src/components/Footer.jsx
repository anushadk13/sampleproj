...
function Footer() {
  return (
    <div className='w-full h-screen bg-zinc-900 p-20 flex gap-20'>
        <div className='w-1/2 flex flex-col justify-between h-full'>
            <div className='heading'>
            <h1 className='text-[6vw] font-semibold uppercase tracking-tight leading-none -mb-10'>Eye-</h1>
            <h1 className='text-[6vw] font-semibold uppercase tracking-tight leading-none -mb-20 mt-5'>Opening</h1>
            </div>
        ...
        <div className='w-1/2 '>
        <h1 className='text-[6vw] font-semibold uppercase tracking-tight leading-none  '>Presentations</h1>
        <div className='dets '>
            <h3 className='uppercase mt-10 py-10'>S:</h3>
            <a className="block font-light text-2xl" href=''>Facebook</a>
            <a className="block font-light text-2xl" href=''>Instagram</a>
            <a className="block font-light text-2xl" href=''>Behance</a>
            <a className="block font-light text-2xl" href=''>Linkdin</a>
        </div>
        </div>
